    ...
    <el-card v-if="SDL_Global[ID]" style="min-height: none !important">
      ...
      <div class="body-btn">
        <el-row
          ...
          v-if="SDL_Global[ID].Code == 'ZJS' || SDL_Global[ID].Code == 'VOCs'"
        >
          <el-col :span="4">
            <el-button
              size="small"
          ...
          <!-- 重金属与vocs没有以下按钮，默认禁用 start-->
          <el-col :span="4">
            <el-button size="small" class="stopBtn" v-bind:disabled="true"
              >零点核查</el-button
            >
          </el-col>
          <el-col :span="4">
          ...
          <!-- 重金属与vocs没有以下按钮，默认禁用  end-->
        </el-row>
        <el-row
          style="margin-bottom: 10px"
          v-else-if="SDL_Global[ID].Code == 'w26001'"
        >
          <el-col :span="4">
            <el-button
              size="small"
            ...
            <el-button
              ...
              @click="
                clickYiBiaoBtn(
                  SDL_Global[ID].MeterStatus,
                  '零点核查',
                  SDL_Global.CMD.YiBiao.Format(SDL_Global[ID].mlName, 3),
                  true
                )
              "
              >零点核查</el-button
            ...
            <el-button
              ...
              @click="
                clickYiBiaoBtn(
                  SDL_Global[ID].MeterStatus,
                  '跨度核查',
                  SDL_Global.CMD.YiBiao.Format(SDL_Global[ID].mlName, 4),
                  true
                )
              "
              >跨度核查</el-button
            ...
            <el-button
              ...
              @click="
                clickYiBiaoBtn(
                  SDL_Global[ID].MeterStatus,
                  '空白测试',
                  SDL_Global.CMD.YiBiao.Format(SDL_Global[ID].mlName, 5),
                  true
                )
              "
              >空白测试</el-button
            ...
            <el-button
              ...
              @click="
                clickYiBiaoBtn(
                  SDL_Global[ID].MeterStatus,
                  '平行样',
                  SDL_Global.CMD.YiBiao.Format(SDL_Global[ID].mlName, 6),
                  true
                )
              "
              >平行样</el-button
      ...
      <div class="body-footer">
        <span
          >仪表时间：<span>{{ SDL_Global[ID].SysTime }}</span></span
        >
