          ...
          <el-card class="box-card">
            <div slot="header" class="clearfix bg-header">
              <span class="c-title">{{ item.Name }} [<span v-bind:class="{
                      'c-status': item.JB_Status >- 1,
                      offline: item.JB_Status == null,
      ...
      <el-dialog :title="dialogForm.title + '-修改值'" :visible.sync="dialogFormVisible" width="40%"
        ...
        <div class="dialogBody">
          ...
          <div class="dialogInput">
            <template v-if="dialogForm.label=='系数范围'">
              <el-input size="small" placeholder="请输入" style="width:45%;" v-model="dialogForm.value">
              </el-input>
              -
              <el-input v-if="dialogForm.label=='系数范围'" style="width:45%;" size="small" placeholder="请输入"
                v-model="dialogForm.value">
                {{ dialogForm.unit }}
              </el-input>
            </template>

            <el-input v-else size="small" placeholder="请输入" v-model="dialogForm.value">
